...
int main()
{
	...
	CCar car[] = { CCar(123,"blue","bmw"),CCar(652,"red","bmw"),CCar(50,"green","audi"),CCar(451,"gray","vw") };
	//Bubblesort(car,4);

	vector<CCar> vec = { CCar(123,"blue","bmw"),CCar(652,"red","bmw"),CCar(50,"green","audi"),CCar(451,"gray","vw") };
	//Bubblesort(vec);
